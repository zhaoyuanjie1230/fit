...
<body class="layui-layout-body">
        ...
        <div class="layui-header custom-header">
            ...
            <ul class="layui-nav layui-layout-right">
                <li class="layui-nav-item">
                    <a href="javascript:;">${loginuser.user_realname}</a>
                    <dl class="layui-nav-child">
                    	<dd>
							<a url="sys/editpassPage">修改密码</a>
						</dd>
                        <dd><a url="backup">备份数据</a></dd>
            ...
            <div class="layui-side-scroll">
                ...
                <ul id="Nav" class="layui-nav layui-nav-tree">
                    <li class="layui-nav-item"><a href="javascript:;"
						><span class="layui-icon layui-icon-group"></span>数据报表</a>
						<dl class="layui-nav-child">
							<dd>
								<a url="datatable_page" href="javascript:;">当年业绩</a>
							</dd>
							<dd>
								<a url="datatable1_page" href="javascript:;">会员消费总额</a>
							</dd>
						</dl>
						</li>
                    <li class="layui-nav-item"><a href="javascript:;"
						url="sys/user_page"><span class="layui-icon layui-icon-group"></span>操作员管理</a></li>
                    <li class="layui-nav-item"><a url="sys/customer_page" href="javascript:;">会员管理</a></li>
					 <li class="layui-nav-item"><a href="javascript:;"
						url="cost_Page"><span class="layui-icon layui-icon-group"></span>消费记录管理</a></li>
                </ul>
	...
	<script src="WEB-INF/page/index.js" data-main="home"></script>
</body>
</html>